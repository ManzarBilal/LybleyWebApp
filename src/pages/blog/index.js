...
const Blog = () => {
    ...
    return (
        <div className='mt-3'>
            ...
            <div className="d-flex justify-content-between">
                <div className="row mt-2">
                   ...
                   <div className='col-12 col-md-4 col-lg-4'>
                        <div className="card">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTN6wNytyE66wwTN0ZGUa_-076XQkDi8tjUeAkAvVCBLGNR-XfIyV8blz6pAd5Gi6Pp4cs&usqp=CAU" className="img-fluid" alt="..." />
            ...
            <h4 className='text-primary mt-5'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Incidunt, officiis?</h4>
            <p>
