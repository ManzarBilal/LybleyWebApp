      ...
      <div className="mt-5 d-flex justify-content-center align-items-center">
        <div>
          ...
          <div className="text-center">
            <h1>Thank You !</h1>
            <p className='p-2'>Your order has been received and is now being processed. Your order details are shown in order page. </p>
            <Link href="/" className='text-decoration-none '><button className="btn btn-primary mt-2">Back Home</button>
            </Link>
          </div>
        </div>
      </div>
