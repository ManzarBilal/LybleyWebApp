...
function OculusVR(props) {
    ...
    const { getSparePart, qty, technician } = props;
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="product-details-content mt-45">
                                        ...
                                        <div className="items-wrapper d-flex" id="select-item-1">
                                            <div className="single-item ">
                                                <div className="items-image lift">
                                                    <img src="https://c8.alamy.com/comp/2F9GW5A/the-electric-motor-from-the-washing-machine-spare-parts-used-to-repair-home-appliances-isolated-background-2F9GW5A.jpg" alt="product" />
                                                </div>
                                    ...
                                    <div className='fw-bold mb-2'>Part Number :  <span className='text-muted'>{" "}{getSparePart?.partNo}</span></div>
